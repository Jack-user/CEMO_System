...
$sql = "SELECT v.*, CONCAT(d.first_name, ' ', d.last_name) AS driver_name,
        m.date_time,  CONCAT('Start Point: ', r.start_point, ' - End Point: ', r.end_point) AS route_info
...
?>
      ...
      <div class="dropdown d-flex justify-content-end mt-2 mb-0" style="max-width: 120px;">
        <button class="btn btn-success fw-bold shadow-sm dropdown-toggle" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
          📅 View
        </button>
